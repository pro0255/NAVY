...
def cv1():
    ...
    X_train = generatePointsInBounds(CONSTANTS.LEFT_PTS, CONSTANTS.RIGHT_PTS, CONSTANTS.NUMBER_OF_PTS)
    y_train = resolveYForPts(X_train)

    X_test = generatePointsInBounds(CONSTANTS.LEFT_PTS, CONSTANTS.RIGHT_PTS, CONSTANTS.NUMBER_OF_PTS)
